...
window.onload = function(e){ 
    ...
    if (!KTCookie.get('metronic_8_engage')) {
        ...
        metronic8Engage.setAttribute('style', 'transform: translateX(-50%); position: fixed; z-index: -1; max-width: 0px; width: 0%; margin: 0 30px; left: 50%; bottom: 60px; background-color: #050421; padding: 20px; border-radius: 6px; box-shadow: 0px 5px 30px rgba(5, 4, 33, 0.3); display: flex; align-items: center; justify-content: space-between;');
